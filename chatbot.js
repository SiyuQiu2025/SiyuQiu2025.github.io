...
class ChatBot {
    constructor() {
        ...
        this.webhookUrl = 'https://siyuuai.app.n8n.cloud/webhook/chat_webhook';
                ...
                <div class="chatbot-panel" id="chatbotPanel">
                    ...
                    <div class="chat-messages" id="chatMessages">
                        <div class="message system">
                            Welcome to AI Assistant! I can answer any questions about Siyu's content or information.
                        </div>
                    </div>
    ...
    loadChatHistory() {
        ...
        if (recentHistory.length === 0) {
            ...
            setTimeout(() => {
                this.addMessage('Hello! I\'m AI Assistant v6. Do you have any questions about Siyu Qiu\'s courses or AI topics?', 'ai');
            }, 1000);
        }
    }
